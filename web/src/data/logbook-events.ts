...
export const mockLogbookEvents: LogbookEvent[] = [
  ...
  // Validation demo events — critical severity, pending/in_progress
  {
    id: "EVT-VAL-001",
    ...
    severity: "critical",
    status: "pending",
    title: "Intrusion détectée - Zone restreinte",
    description:
      "Caméra de surveillance a détecté un mouvement non autorisé dans la zone restreinte du parking souterrain niveau -2. Individu non identifié en tenue sombre. Vérification sur site requise en urgence.",
    agentId: "AGT-125",
    agentName: "Jean Dupont",
    clientNotified: false,
    tags: ["intrusion", "camera", "urgence", "zone-restreinte"],
    media: {
      photos: ["/logbook/val-001-cam1.jpg", "/logbook/val-001-cam2.jpg"],
      videos: ["/logbook/val-001-video.mp4"],
    },
    location: {
      lat: 48.8566,
      lng: 2.3522,
  ...
  {
    id: "EVT-VAL-002",
    timestamp: "2024-12-24T11:40:00Z",
    site: "Entrepôt Logistique Nord",
    siteId: "SITE-003",
    zone: "Quai de chargement",
    type: "incident",
    severity: "critical",
    status: "in_progress",
    title: "Agression agent de sécurité",
    description:
      "L'agent Thomas Petit a été agressé physiquement par un individu lors d'un contrôle au quai de chargement. L'agent a été légèrement blessé. Police nationale contactée. Auteur toujours sur les lieux.",
    agentId: "AGT-234",
    agentName: "Thomas Petit",
    clientNotified: true,
    tags: ["agression", "police", "blessure", "urgence"],
    media: {
      photos: ["/logbook/val-002-scene.jpg"],
      voiceNotes: ["/logbook/val-002-temoin.mp3"],
    },
    location: {
      lat: 50.6292,
      lng: 3.0573,
  ...
  {
    id: "EVT-VAL-003",
    timestamp: "2024-12-24T13:05:00Z",
    site: "Tour de Bureaux Skyline",
    siteId: "SITE-002",
    zone: "Salle des serveurs",
    type: "critical",
    severity: "critical",
    status: "pending",
    title: "Défaillance système de détection incendie",
    description:
      "Panne totale du système de détection incendie signalée par la centrale de supervision. 12 détecteurs hors ligne sur le niveau 8. Maintenance d'urgence demandée. Rondes manuelles en renfort toutes les 30 minutes.",
    agentId: "AGT-087",
    agentName: "Sophie Bernard",
    clientNotified: true,
    tags: ["incendie", "panne", "detecteur", "maintenance", "critique"],
    media: {
      photos: ["/logbook/val-003-centrale.jpg"],
    },
  },
  {
    id: "EVT-VAL-004",
    timestamp: "2024-12-24T15:20:00Z",
    site: "Campus Technologique",
    siteId: "SITE-004",
    zone: "Entrée Bâtiment R&D",
    type: "incident",
    severity: "critical",
    status: "pending",
    title: "Colis suspect abandonné",
    description:
      "Colis de taille moyenne abandonné sans surveillance à l'entrée du bâtiment R&D depuis plus de 45 minutes. Périmètre de sécurité établi. Démineurs et police scientifique alertés. Zone évacuée dans un rayon de 50 mètres.",
    agentId: "AGT-156",
    agentName: "Julie Moreau",
    clientNotified: true,
    tags: ["colis-suspect", "evacuation", "police", "demineur"],
    location: {
      lat: 43.6047,
      lng: 1.4442,
    },
  ...
  {
    id: "EVT-VAL-005",
    timestamp: "2024-12-24T17:50:00Z",
    site: "Centre Commercial Atlantis",
    siteId: "SITE-001",
    zone: "Galerie Commerciale",
    type: "action",
    severity: "critical",
    status: "in_progress",
    title: "Malaise grave - Intervention SAMU",
    description:
      "Visiteur en arrêt cardiaque dans la galerie commerciale. RCP initiée par l'agent. Défibrillateur utilisé. SAMU arrivé sur place. Patient pris en charge. Accès sécurisé pour ambulance. Rapport médical à compléter.",
    agentId: "AGT-125",
    agentName: "Jean Dupont",
    clientNotified: true,
    tags: ["malaise", "samu", "rcp", "defibrillateur", "urgence-medicale"],
    media: {
      photos: ["/logbook/val-005-intervention.jpg"],
      voiceNotes: ["/logbook/val-005-rapport.mp3"],
    },
    location: {
      lat: 48.8566,
      lng: 2.3522,
