...
export function GenericSidebar({
  ...
  return (
    <Sidebar collapsible="icon" className="border-r-0 bg-sidebar">
      ...
      <SidebarHeader
        className={cn(
          "flex flex-row items-center justify-between p-2 h-16 border-b border-sidebar-border/50",
        )}
      >
        {isExpanded ? headerContent : logo}
        {isExpanded && (
          <button
      ...
      {/* Navigation Content */}
      <SidebarContent className={cn("py-3 scrollbar-thin px-1")}>
        {/* Search Input */}
        {isExpanded && (
          <div className="relative mb-3 px-2">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 h-5 w-5 flex items-center justify-center rounded-sm hover:bg-sidebar-accent"
              >
